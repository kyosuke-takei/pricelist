...
const SEARCH_URLS = [
  'https://snkrdunk.com/search?searchCategoryIds=6%2F26&brandIds=yu-gi-oh&sort=hottest',
  'https://snkrdunk.com/search?searchCategoryIds=6%2F27&brandIds=yu-gi-oh',
  'https://snkrdunk.com/search?searchCategoryIds=6%2F28&brandIds=yu-gi-oh',
];

const CACHE_FILE = 'yugioh_cache.json';

const LABEL_SHRINK_ON  = '遊戯王 BOX シュリンクあり';
const LABEL_SHRINK_OFF = '遊戯王 BOX シュリンクなし';
const LABEL_PACK       = '遊戯王 パック';
const LABEL_DECK       = '遊戯王 デッキ';
const LABEL_PROMO      = '遊戯王 プロモ';
const LABEL_OTHER      = '遊戯王 その他';
...
(async () => {
  ...
  console.log(`[遊戯王] ラベルキャッシュ読み込み: ${cachedCount}件\n`);
